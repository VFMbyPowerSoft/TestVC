...
namespace Projects
{
    public partial class ShowDataAccout1 : Form
    {
        ...
        private void ShowDataAccout1_Load(object sender, EventArgs e)
        {
            c.Open();
            cmd.Connection = c;
            loadData();
        }
        private void ShowDataAccout1_Unload(object sender, EventArgs e)
        {
            c.Close();
        }
